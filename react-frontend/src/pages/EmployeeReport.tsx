    ...
    printWindow.document.write(`
      ...
      <head>
        ...
        <style>
          ...
          .insight { background-color: #eff6ff; border-left: 4px solid #3b82f6; padding: 15px; margin: 10px 0; }
          @media print {
            body { padding: 20px; }
      ...
      {loading ? (
        ...
        <>
              ...
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                  <span className="text-blue-600 font-medium">
                    {reportData.employee.name.split(' ').map(n => n[0]).join('').toUpperCase().slice(0, 2)}
                  </span>
                </div>
                <div className="flex-1 grid grid-cols-2 gap-4">
                  <div>
                    <div className="text-sm text-gray-600">Name</div>
                    <div className="font-medium text-gray-900">{reportData.employee.name}</div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-600">Email</div>
                    <div className="font-medium text-gray-900">{reportData.employee.email}</div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-600">Department</div>
                    <div className="font-medium text-gray-900">{reportData.employee.department || 'N/A'}</div>
                  </div>
                  <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-sm text-gray-600">Total Worked Hours</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-sm text-gray-600">Productivity</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-sm text-gray-600">Idle Time</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-sm text-gray-600">Late Starts</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-sm text-gray-600">Early Logouts</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-semibold text-yellow-600">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-sm text-gray-600">On-Time Starts</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-semibold text-green-600">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-900">Punctuality</span>
                    <Badge variant={getInsightBadge(reportData.insights.punctuality)}>
                      {reportData.insights.punctuality}
                    </Badge>
                  </div>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-900">Idle Time Management</span>
